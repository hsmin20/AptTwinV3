...
export class Window extends Opening {
    ...
    _calculate(sizeObj, thickObj) {
        ...
        this.pushToConstruc(construc, "M " + (-sizeObj / 2) + ",-2 L " + (-sizeObj / 2) + ",0 L 2,0 L 2,2 L 3,2 L 3,-2 Z", "#ccc", "none", '');
        this.pushToConstruc(construc, "M -2,1 L -2,3 L " + sizeObj / 2 + ",3 L " + sizeObj / 2 + ",1 L -1,1 L -1,-1 L -2,-1 Z", "#ccc", "none", '');
...
export class Window2 extends Opening {
    constructor(pos, angle, size, thick) {
        super(pos, angle, size, thick);

        this.type = WallType.WINDOW2;
    ...
    _calculate(sizeObj, thickObj) {
        ...
        this.pushToConstruc(construc, "M " + (-sizeObj / 2) + ",4 L " + (-sizeObj / 2) + ",0 L" + (-sizeObj / 4) + ",0 L" + (-sizeObj / 4) + ",4 Z", "#ccc", "none", '');
        this.pushToConstruc(construc, "M " + (-sizeObj / 4) + ",-4 L " + (-sizeObj / 4) + ",0 L -1,0 L -1,-4 Z", "#ccc", "none", '');
        this.pushToConstruc(construc, "M 1,0 L 1,-4 L " + sizeObj / 4 + ",-4 L " + sizeObj / 4 + ",0 Z", "#ccc", "none", '');
        this.pushToConstruc(construc, "M " + (sizeObj / 4) + ",4 L " + (sizeObj / 4) + ",0 L" + (sizeObj / 2) + ",0 L " + (sizeObj / 2) + ",4 Z", "#ccc", "none", '');
