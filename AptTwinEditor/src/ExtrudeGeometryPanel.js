...
export class ExtrudeGeometryPanel {
    constructor( editor ) {
        ...
        this.insideMap = new UITexture2( showTextureImagesByIndex3 ).onChange( onMapChangedFunc );
        ...
        this.bottomMap = new UITexture2( showTextureImagesByIndex4 ).onChange( onMapChangedFunc );
